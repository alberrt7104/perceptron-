    ...
    with open("income.train.txt","r") as f:
            ...
            for line in lines:
                ...
                if (y==1 and salary['<=50K\n'])or(y==-1 and salary['>50K\n']):
                    ...
                    w[0]=tau*y*-1*age+w[0]
                    for num in range(0,len(workclass)):
                        w[num+1]=tau*y*-1*workclass[key_workclass[num]]+w[num+1]
                    for num in range(0,len(education)):
                        w[num+1+len(workclass)]=tau*y*-1*education[key_education[num]]+w[num+1+len(workclass)]
                    for num in range(0,len(maritalstatus)):
                        w[num+1+len(workclass)+len(education)]=tau*y*-1*maritalstatus[key_maritalstatus[num]]+w[num+1+len(workclass)+len(education)]
                    for num in range(0,len(occupation)):
                        w[num+1+len(workclass)+len(education)+len(maritalstatus)]=tau*y*-1*occupation[key_occupation[num]]+w[num+1+len(workclass)+len(education)+len(maritalstatus)]
                    for num in range(0,len(race)):
                        w[num+1+len(workclass)+len(education)+len(maritalstatus)+len(occupation)]=tau*y*-1*race[key_race[num]]+w[num+1+len(workclass)+len(education)+len(maritalstatus)+len(occupation)]
                    for num in range(0,len(sex)):
                        w[num+1+len(workclass)+len(education)+len(maritalstatus)+len(occupation)+len(race)]=tau*y*-1*sex[key_sex[num]]+w[1+len(workclass)+len(education)+len(maritalstatus)+len(occupation)+len(race)]
                    w[1+len(workclass)+len(education)+len(maritalstatus)+len(occupation)+len(race)+len(sex)]=tau*y*-1*hours+w[1+len(workclass)+len(education)+len(maritalstatus)+len(occupation)+len(race)+len(sex)]
                    for num in range(0,len(nativecountry)):
                        w[num+1+len(workclass)+len(education)+len(maritalstatus)+len(occupation)+len(race)+len(sex)+1]=tau*y*-1*nativecountry[key_nativecountry[num]]+w[num+1+len(workclass)+len(education)+len(maritalstatus)+len(occupation)+len(race)+len(sex)+1]
